...
env.Replace(CXX='/usr/bin/g++-7')
env.Replace(CC='/usr/bin/gcc-7')
includes = '''
              .
              ./lib/include
              ./lib/include/base
...
env.Append(CXXFLAGS=['-std=c++17', '-lboost_program_options',  '-lboost_filesystem', '-lboost_system', '-g'] )
...
#env.SharedLibrary('foo', ['maestro-top.cpp', 'lib/src/BASE_base-objects.cpp' ])
